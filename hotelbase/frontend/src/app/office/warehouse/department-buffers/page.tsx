...
const DEPARTMENTS = [
  ...
  { value: 'FRONT_DESK', label: 'Front Desk', icon: '🏨' },
  ...
  const fetchDepartmentBuffers = async () => {
    ...
    try {
      const response = await fetch(
        buildApiUrl(`department-inventory/?department=${selectedDepartment}`),
        { credentials: 'include' }
      );
      if (response.ok) {
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-[#4E61D3] text-white rounded hover:bg-[#3d4db5] transition"
            >
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <button className="mt-4 px-4 py-2 bg-[#4E61D3] text-white rounded hover:bg-[#3d4db5]">
                Add Items
              </button>
            </div>
          ) : (
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {buffers.map((buffer) => (
                    <tr key={buffer.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded ${getStockStatusColor(buffer.stock_status)}`}>
                          {buffer.stock_status}
                        </span>
                      </td>
                      <td className="px-6 py-4">
                        <button
                          ...
                          className="flex items-center space-x-1 px-3 py-1.5 bg-[#4E61D3] text-white text-sm rounded hover:bg-[#3d4db5] transition"
                        >
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
              ...
              <div className="p-6 border-t border-gray-200 flex space-x-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-[#4E61D3] text-white rounded hover:bg-[#3d4db5] transition disabled:bg-gray-300 disabled:cursor-not-allowed"
                >
                  Transfer Stock
                </button>
              </div>
