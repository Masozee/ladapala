...
class HotelSettings(models.Model):
    ...
    logo = models.ImageField(upload_to='settings/logos/', blank=True, null=True, help_text='Hotel logo (recommended: 200x200px)')
    logo_url = models.CharField(max_length=200, default='/logo.png', help_text='Fallback if no logo uploaded')
