# Generated by Django 5.2.7 on 2025-11-15 00:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('hotel', '0042_alter_departmentinventory_department'),
    ...
    operations = [
        migrations.AlterField(
            ...
            name='department',
            field=models.CharField(choices=[('HOUSEKEEPING', 'Housekeeping'), ('F&B', 'Food & Beverage'), ('MAINTENANCE', 'Maintenance'), ('FRONT_DESK', 'Front Desk'), ('ENGINEERING', 'Engineering'), ('LAUNDRY', 'Laundry')], max_length=20),
        ),
