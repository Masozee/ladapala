...
Shared across hotel and restaurant apps
"""
...
# Add backend directory to path for license import
...
def validate_license(request):
    """
    Validate a license key against the backend's valid keys list.
...
def get_license_status(request):
    ...
    return Response({
        ...
        'total_valid_keys': license_info['total_valid_keys']
    })
