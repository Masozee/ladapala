...
class Payment(models.Model):
    ...
    # Room charge fields
    is_room_charge = models.BooleanField(default=False, help_text='Charge to hotel guest room')
    room_number = models.CharField(max_length=20, blank=True, null=True, help_text='Hotel room number')
    guest_name = models.CharField(max_length=200, blank=True, null=True, help_text='Hotel guest name')
    hotel_reservation_id = models.IntegerField(blank=True, null=True, help_text='Reference to hotel reservation')
