...
from ..models.promotions import Voucher, LoyaltyProgram, GuestLoyaltyPoints, LoyaltyTransaction
...
class PaymentCalculator:
    ...
    def redeem_loyalty_points(self, points_to_redeem):
        ...
        remaining_after_discounts = self.subtotal - self.voucher_discount
    ...
    def calculate(self, voucher_code=None, redeem_points=0):
        ...
        return {
            ...
            'total_discount': str(self.voucher_discount + self.points_redeemed_value),
            'breakdown': {
