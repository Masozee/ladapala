...
import { OccupancyReportPDF, RevenueReportPDF, GuestAnalyticsPDF, SatisfactionReportPDF, MaintenanceReportPDF, InventoryReportPDF, FullReportPDF, GenericReportPDF } from '@/components/reports';
