        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 border p-6">
            ...
            <div className="space-y-3">
              ...
              <Link href="/frontline/lost-and-found/new" className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors block">
                <div className="flex items-center space-x-3">
                  <Archive03Icon className="h-4 w-4 text-gray-500" />
