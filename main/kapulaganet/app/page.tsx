        ...
        <div className="container mx-auto max-w-6xl px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-zinc-900">Kapulaga</span>
            </div>
            <div className="flex items-center gap-8">
              ...
              <a href="https://bit.ly/nuroji" className="rounded-lg bg-zinc-900 px-6 py-2 text-sm font-medium text-white transition-colors hover:bg-zinc-800">
                Contact Us
              </a>
            </div>
          </div>
        ...
        <section className="container mx-auto max-w-6xl px-6 py-24">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              <a href="https://bit.ly/nuroji" className="rounded-lg bg-zinc-900 px-8 py-4 text-lg font-semibold text-white transition-all hover:scale-105 hover:bg-zinc-800">
                Get Started
              </a>
              <a href="https://bit.ly/nuroji" className="rounded-lg border-2 border-zinc-900 px-8 py-4 text-lg font-semibold text-zinc-900 transition-all hover:scale-105 hover:bg-zinc-50">
                Watch Demo
              </a>
            </div>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div>
              <div className="mb-4 flex items-center gap-2">
                <Image src="/logo.png" alt="Kapulaga" width={120} height={40} className="h-8 w-auto" />
                <span className="text-xl font-bold text-zinc-900">Kapulaga</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-zinc-600">
                ...
                <li><a href="https://bit.ly/nuroji" className="hover:text-zinc-900">Demo</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-zinc-600">
                ...
                <li><a href="https://bit.ly/nuroji" className="hover:text-zinc-900">Contact</a></li>
