          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-700">{totalTables}</p>
              </div>
              <HugeiconsIcon icon={UserIcon} size={32} strokeWidth={2} className="text-[#58ff34]" />
            </div>
          </CardContent>
        </Card>
        <Card className="rounded-xl border border-gray-200 shadow-none hover:border-[#58ff34] transition-colors">
        ...
        <Card className="rounded-xl border border-gray-200 shadow-none hover:border-[#58ff34] transition-colors">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <HugeiconsIcon icon={UserIcon} size={32} strokeWidth={2} className="text-green-500" />
            </div>
          </CardContent>
        </Card>
        <Card className="rounded-xl border border-gray-200 shadow-none hover:border-[#58ff34] transition-colors">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-gray-700">Rp {totalRevenue.toLocaleString('id-ID')}</p>
              </div>
